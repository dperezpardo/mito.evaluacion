...
public class Signos {
	...
	private String temperatura;//Promedio de 37ºC - 36.5°C a 37.3°C
	
	@NotEmpty
	@Column(name = "pulso", nullable = false, length = 30)
	private String pulso;//60 a 100 latidos por minuto
	
	@NotEmpty
	@Column(name = "ritmoRespiratorio", nullable = false, length = 40)
	private String ritmoRespiratorio;//12 a 18 respiraciones por minuto
